...
template<typename T>
inline static constexpr T sigmoid_sin(T value) noexcept __attribute__((__always_inline__));
template<typename T>
inline static constexpr T sigmoid_sin(T value) noexcept {
...
template<typename T>
inline static constexpr T sigmoid_tanh(T value) noexcept __attribute__((__always_inline__));
template<typename T>
inline static constexpr T sigmoid_tanh(T value) noexcept {
...
template<typename T>
inline static constexpr T sigmoid_log(T value) noexcept __attribute__((__always_inline__));
template<typename T>
inline static constexpr T sigmoid_log(T value) noexcept {
...
template<typename T>
inline static constexpr T sigmoid_erf(T value) noexcept __attribute__((__always_inline__));
template<typename T>
inline static constexpr T sigmoid_erf(T value) noexcept {
